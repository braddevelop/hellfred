...
--- @param meta any Custom meta generated by the query interceptor function (-- todo wait is this correct?)
---
...
--- @param fn any
---
--- I think this is an optional feature that acts as a pipe
--- allowing the user to draw insights from the users typing
...
---
--- @param keySpec table
--- @return table The Hellfuzz object
--- @usage
---     hellfuzz.init({{'cmd'},'f19'})
---
